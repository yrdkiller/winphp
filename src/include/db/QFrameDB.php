...
class QFrameDBPDO
{
	...
	private $_reconnected    = false; //�Ƿ���Ҫ��������
	private $_auto_reconnect = true;  //�Ƿ���Ҫ�����Զ�����
	...
	{/*{{{*/
		if($this->_transaction) {
			throw new QFrameDBException("֮ǰ������������δ���������?��Ƕ�ײ���!");
		}
	...
	{/*{{{*/
		if(!$this->_transaction) {
			throw new QFrameDBException("֮ǰ�����������Ѿ����ύ��û�п���������ϸ�鿴���������еĲ������!");
		}
